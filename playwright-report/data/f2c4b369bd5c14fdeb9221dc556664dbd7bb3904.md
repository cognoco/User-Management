...
- Name: Admin Dashboard >> should redirect non-admin users attempting to access admin dashboard
- Location: /workspaces/ZDX-UM/user-management-reorganized/e2e/admin/dashboard.spec.ts:56:3
