...
const postHandler = async ({ request, data, userId, services }: { request: any, data: z.infer<typeof RequestSchema>, userId?: string, services: any }) => {
...
const handler = withValidatedServices({
