...
**Passed Test Files:** 96  |  **Failed Test Files:** 383  |  **Skipped/Timeout Test Files:** 1
...
- app\api\payments\checkout\__tests__\route.test.ts
...
- app\api\payments\invoices\__tests__\route.test.ts
...
- src\hooks\user\__tests__\useUserProfile.test.tsx
...
- src\lib\monitoring\__tests__\correlation-id.test.tsx
...
- src\lib\utils\__tests__\error-factory.server.test.ts
...
- src\middleware\__tests__\validate-auth-token.test.ts
...
- src\services\auth\__tests__\simple.test.ts
...
- src\services\health\__tests__\system-health.service.test.ts
...
- src\tests\examples\route-test-example.test.ts
...
- src\tests\integration\auth-completion.test.ts
...
- src\tests\integration\stripe-api-routes.test.ts
- src\tests\integration\stripe-payment-flow.test.ts
- src\tests\integration\stripe-service.test.ts
...
- src\ui\styled\profile\__tests__\ProfileForm.test.tsx
